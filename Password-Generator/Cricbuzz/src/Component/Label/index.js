...
class Label extends React.Component {
    ...
    render() {
        ...
        if (this.props.font_medium) {
            stylesArray.push({fontFamily: ThemeUtils.FontStyle.ProDisplay.medium});
        } else if (this.props.font_regular) {
            stylesArray.push({fontFamily: ThemeUtils.FontStyle.ProDisplay.regular});
        } else if (this.props.font_ui_regular) {
            stylesArray.push({fontFamily: ThemeUtils.FontStyle.UIDisplay.regular});
        } else if (this.props.font_ui_medium) {
            stylesArray.push({fontFamily: ThemeUtils.FontStyle.UIDisplay.medium});
        } else {
            stylesArray.push({fontFamily: ThemeUtils.FontStyle.ProDisplay.regular});
        }
        ...
        return (
            <Text
                numberOfLines={this.props.singleLine ? 1 : this.props.maxLine ? this.props.maxLine : null}
                style={stylesArray}
...
Label.defaultProps = {
    ...
    font_regular: false,
    font_medium: false,
    font_ui_regular: false,
    font_ui_medium: false,
    align: 'left',
    mt: 0,
    mb: 0,
    ms: 0,
